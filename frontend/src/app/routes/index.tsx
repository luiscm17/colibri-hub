...
const router = createBrowserRouter([
  ...
  { path: '/password-change', element: <PasswordChangeOnly><MandatoryPasswordChangePage /></PasswordChangeOnly>, errorElement: <RouteErrorBoundary /> },
  {
    ...
    children: [
      ...
      { path: 'access/roles/new', element: protectAdministration('/access/roles', <AccessAdministrationPage family="roles" />) },
      ...
      { path: 'access/presets/new', element: protectAdministration('/access/presets', <AccessAdministrationPage family="presets" />) },

...
export const AccessAdministrationEditPage = lazy(() => import('@/features/access-control/administration/AdministrationPage').then(({ AdministrationEditPage }) => ({ default: AdministrationEditPage })))

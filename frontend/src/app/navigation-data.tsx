...
export const navData: NavItem[] = [
    {
        ...
        children: [
            {
                label: "Gestión de fardos",
                path: "/warehouse/bales",
                icon: <IconPackage size={16} />,
            },
            {
                label: "Stock de fardos",
                path: "/warehouse/bales/stock",
                icon: <IconHistory size={16} />,
            },
            {
                label: "Entrega de fardos",
                path: "/warehouse/bales/delivery",
                icon: <IconTruckDelivery size={16} />,
            },
            {
                label: "Identidad de producción",
                path: "/warehouse/identity",
                icon: <IconPackageImport size={16} />,
            },
            {
                label: "Producto terminado",
                path: "/warehouse/finished-product",
                icon: <IconPackageImport size={16} />,
            },
    ...
    },
    {
        ...
        children: [
            {
                label: "Preparación",
                path: "/spinning/preparation",
                icon: <IconDashboard size={16} />,
            },
            {
                label: "Continuas",
                path: "/spinning/ring-spinning",
                icon: <IconDashboard size={16} />,
            },
            {
                label: "Bobinados",
                path: "/spinning/bobbin-winding",
                icon: <IconDashboard size={16} />,
            },
            {
                label: "Retorcedoras",
                path: "/spinning/twisting",
                icon: <IconDashboard size={16} />,
            },
            { label: "Madejeras", path: "/spinning/skeining", icon: <IconDashboard size={16} /> },
            {
                label: "Control de Calidad",
                path: "/spinning/quality",

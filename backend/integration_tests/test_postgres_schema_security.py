...
class PostgreSQLSchemaSecurityTests(unittest.TestCase):
    ...
    def test_schema_constraints_and_index_match_the_current_migration(self) -> None:
        with self.engine.connect() as connection:
            ...
            index_definition = connection.execute(text("SELECT indexdef FROM pg_indexes WHERE schemaname = 'public' AND indexname = 'ix_raw_material_bales_raw_material_batch_id'"))
        ...
        self.assertEqual(columns, [
            ...
            ("raw_material_batches", "received_at", "timestamp with time zone", None, "NO", None),
        ...
        self.assertIn("(raw_material_batch_id)", index_definition.scalar_one())

...
- The 6 productive stages and their state machine (→ [`docs/prd/operation.md`](../operation.md))
...
| Dependency | Reason |
| --- | --- |
| [`docs/prd/operation.md`](../operation.md) | Receives PT from Operations; reads lot productive data |
